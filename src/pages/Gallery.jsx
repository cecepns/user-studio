...
const Gallery = () => {
  ...
  const fetchGalleryData = async () => {
    try {
      ...
      // Fetch categories
      const categoriesResponse = await fetch('https://api.kingcreativestudio.my.id/user-studio/api/gallery/categories');
      const categoriesData = await categoriesResponse.json();
      setCategories(categoriesData);
      
      // Fetch images
      const imagesResponse = await fetch('https://api.kingcreativestudio.my.id/user-studio/api/gallery/images');
  ...
  const fetchHeroContent = async () => {
    try {
      const response = await fetch('https://api.kingcreativestudio.my.id/user-studio/api/content-sections/gallery_hero_section');
      if (response.ok) {
