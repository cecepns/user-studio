...
const AdminContent = () => {
  ...
  const fetchSections = async () => {
    try {
      const response = await fetch('https://api-inventory.isavralabel.com/user-studio/api/content-sections?is_active=false', {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingSection 
        ? `https://api-inventory.isavralabel.com/user-studio/api/content-sections/${editingSection.id}`
        : 'https://api-inventory.isavralabel.com/user-studio/api/content-sections';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://api-inventory.isavralabel.com/user-studio/api/content-sections/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
