...
const AdminServiceFeatures = () => {
  ...
  const fetchFeatures = async () => {
    try {
      ...
      const response = await fetch(
        "https://api-inventory.isavralabel.com/user-studio/api/service-features",
        {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingFeature
        ? `https://api-inventory.isavralabel.com/user-studio/api/service-features/${editingFeature.id}`
        : "https://api-inventory.isavralabel.com/user-studio/api/service-features";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem("adminToken");
      const response = await fetch(
        `https://api-inventory.isavralabel.com/user-studio/api/service-features/${id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
