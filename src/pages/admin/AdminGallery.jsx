...
const AdminGallery = () => {
  ...
  const fetchImages = async () => {
    try {
      const url = selectedCategory === 'all' 
        ? 'https://api.kingcreativestudio.my.id/user-studio/api/gallery/images'
        : `https://api.kingcreativestudio.my.id/user-studio/api/gallery/images?category_id=${selectedCategory}`;
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch('https://api.kingcreativestudio.my.id/user-studio/api/gallery/categories', {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
      });
  ...
  const handleImageSubmit = async (e) => {
    ...
    try {
      const url = editingImage 
        ? `https://api.kingcreativestudio.my.id/user-studio/api/gallery/images/${editingImage.id}`
        : 'https://api.kingcreativestudio.my.id/user-studio/api/gallery/images';
  ...
  const handleCategorySubmit = async (e) => {
    ...
    try {
      const url = editingCategory 
        ? `https://api.kingcreativestudio.my.id/user-studio/api/gallery/categories/${editingCategory.id}`
        : 'https://api.kingcreativestudio.my.id/user-studio/api/gallery/categories';
  ...
  const handleDeleteImage = async (id) => {
    ...
    try {
      const response = await fetch(`https://api.kingcreativestudio.my.id/user-studio/api/gallery/images/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
  ...
  const handleDeleteCategory = async (id) => {
    ...
    try {
      const response = await fetch(`https://api.kingcreativestudio.my.id/user-studio/api/gallery/categories/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
