...
const AdminServiceCards = () => {
  ...
  const fetchCards = async () => {
    try {
      const response = await fetch('https://api-inventory.isavralabel.com/user-studio/api/service-cards', {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingCard 
        ? `https://api-inventory.isavralabel.com/user-studio/api/service-cards/${editingCard.id}`
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://api-inventory.isavralabel.com/user-studio/api/service-cards/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
