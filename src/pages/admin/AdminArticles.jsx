...
const AdminArticles = () => {
  ...
  const handleSubmit = async (articleData) => {
    try {
      const url = editingArticle 
        ? `https://api.kingcreativestudio.my.id/user-studio/api/articles/${editingArticle.id}`
        : 'https://api.kingcreativestudio.my.id/user-studio/api/articles';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://api.kingcreativestudio.my.id/user-studio/api/articles/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
