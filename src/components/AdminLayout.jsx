...
const AdminLayout = ({ children }) => {
  ...
  { name: 'Kalender', path: '/admin/orders', icon: 'M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
  { name: 'History', path: '/admin/orders-history', icon: 'M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
    ...
    { name: 'Pengaturan', path: '/admin/settings', icon: 'M10.325 4.317a1 1 0 011.35-.937l.39.13a1 1 0 00.95-.174l.273-.218a1 1 0 011.414.09l1.414 1.414a1 1 0 01.09 1.414l-.218.273a1 1 0 00-.174.95l.13.39a1 1 0 01-.937 1.35l-.403.036a1 1 0 00-.89.89l-.036.403a1 1 0 01-1.35.937l-.39-.13a1 1 0 00-.95.174l-.273.218a1 1 0 01-1.414-.09L7.05 13.05a1 1 0 01-.09-1.414l.218-.273a1 1 0 00.174-.95l-.13-.39a1 1 0 01.937-1.35l.403-.036a1 1 0 00.89-.89l.036-.403z' },
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Sidebar */}
      <div className={`inset-y-0 left-0 z-30 w-64 bg-white shadow-lg transform fixed ${
        isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
      } transition-transform duration-300 ease-in-out lg:translate-x-0 lg:inset-0`}>
        <div className="flex items-center justify-center h-20 px-4 bg-gradient-to-r from-primary-600 to-secondary-600">
          <Link to="/" className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center">
              <span className="text-primary-600 font-bold">U</span>
            </div>
            <span className=" text-xl font-bold text-white">User Studio</span>
          </Link>
        </div>
